...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_proxy
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_proxy.chkp_api_call'
api_call_object = 'proxy'


class TestCheckpointProxy(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['proxy'].items()
