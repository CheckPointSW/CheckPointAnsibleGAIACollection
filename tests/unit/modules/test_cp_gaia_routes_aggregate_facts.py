...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_routes_aggregate_facts.chkp_facts_api_call'
api_call_object = 'routes-aggregate'


class TestCheckpointRoutesAggregateFacts(object):
    module = cp_gaia_routes_aggregate_facts
