...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_banner_facts
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_banner_facts.chkp_facts_api_call'
api_call_object = 'banner'


class TestCheckpointBannerFacts(object):
