...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_user

EXPECTED_RESULT = {
    'allow_access_using': ['CLI', 'Web-UI'],
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_user.chkp_api_call'
api_call_object = 'user'


class TestCheckpointUser(object):
    module = cp_gaia_user
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['user'].items()
