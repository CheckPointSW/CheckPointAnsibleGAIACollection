...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_message_of_the_day_facts
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_message_of_the_day_facts.chkp_facts_api_call'
api_call_object = 'message-of-the-day'


class TestCheckpointMessageOfTheDayFacts(object):
