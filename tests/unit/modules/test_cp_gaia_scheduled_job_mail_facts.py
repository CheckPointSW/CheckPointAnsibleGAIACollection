...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_scheduled_job_mail_facts.chkp_facts_api_call'
api_call_object = 'scheduled-job-mail'


class TestCheckpointScheduledJobMailFacts(object):
