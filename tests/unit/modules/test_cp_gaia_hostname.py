...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_hostname
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_hostname.chkp_api_call'
api_call_object = 'hostname'


class TestCheckpointHostname(object):
