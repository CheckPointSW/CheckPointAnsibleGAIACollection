...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_allowed_clients
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_allowed_clients.chkp_api_call'
api_call_object = 'allowed-clients'


class TestCheckpointAllowedClients(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['allowed_clients'].items()
