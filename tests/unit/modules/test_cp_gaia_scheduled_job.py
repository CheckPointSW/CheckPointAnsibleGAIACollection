...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_scheduled_job
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_scheduled_job.chkp_api_call'
api_call_object = 'scheduled-job'


class TestCheckpointScheduledJob(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['scheduled_job'].items()
