...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_role
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_role.chkp_api_call'
api_call_object = 'role'


class TestCheckpointRole(object):
    module = cp_gaia_role
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['role'].items()
