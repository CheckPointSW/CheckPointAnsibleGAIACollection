...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_tacacs_server_facts.chkp_facts_api_call'
api_call_object = 'tacacs'


class TestCheckpointTacacsServerFacts(object):
    module = cp_gaia_tacacs_server_facts
