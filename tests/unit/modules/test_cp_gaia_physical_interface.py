...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_physical_interface.chkp_api_call'
...
class TestCheckpointPhysicalInterface(object):
    ...
    def test_idempotent(self, mocker, connection_mock):
        ...
        mock_function.side_effect = [set_response]
        result = self._run_module(NOT_CHANGED_PAYLOAD)
        assert not result['changed']
        assert EXPECTED_RESULT.items() == result['physical_interface'].items()
