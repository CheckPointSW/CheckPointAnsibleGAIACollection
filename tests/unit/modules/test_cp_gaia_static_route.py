...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_static_route
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_static_route.chkp_api_call'
api_call_object = 'static-route'


class TestCheckpointStaticRoute(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['static_route'].items()
