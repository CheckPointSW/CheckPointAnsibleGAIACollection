...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_message_of_the_day
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_message_of_the_day.chkp_api_call'
api_call_object = 'message-of-the-day'


class TestCheckpointMessageOfTheDay(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['message_of_the_day'].items()
