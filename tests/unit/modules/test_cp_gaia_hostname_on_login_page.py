...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_hostname_on_login_page
...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_hostname_on_login_page.chkp_api_call'
api_call_object = 'hostname-on-login-page'


class TestCheckpointHostnameOnLoginPage(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['hostname_on_login_page'].items()
