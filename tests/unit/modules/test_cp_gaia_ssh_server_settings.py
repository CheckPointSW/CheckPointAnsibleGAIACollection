...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_ssh_server_settings
...
class TestCheckpointSshServerSettings(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['ssh_server_settings'].items()
