...
from ansible_collections.check_point.gaia.plugins.modules import cp_gaia_banner
...
PAYLOAD = {
    "msg": "This is a new banner message"
}

function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_banner.chkp_api_call'
api_call_object = 'banner'


class TestCheckpointBanner(object):
    ...
    def run_wrapper(self, mocker, connection_mock, changed):
        ...
        assert EXPECTED_RESULT.items() == result['banner'].items()
