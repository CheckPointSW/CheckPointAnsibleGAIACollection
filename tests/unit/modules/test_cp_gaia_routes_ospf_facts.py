...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_routes_ospf_facts.chkp_facts_api_call'
api_call_object = 'routes-ospf'


class TestCheckpointRoutesOspfFacts(object):
    module = cp_gaia_routes_ospf_facts
