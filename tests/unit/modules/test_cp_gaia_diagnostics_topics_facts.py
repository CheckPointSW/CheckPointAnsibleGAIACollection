...
function_path = 'ansible_collections.check_point.gaia.plugins.modules.cp_gaia_diagnostics_topics_facts.chkp_facts_api_call'
api_call_object = 'diagnostics-topics'


class TestCheckpointDiagnosticsTopicsFacts(object):
