...
* `cp_gaia_virtual_switch` – manages virtual switch on Check Point machine VSNext over Web Services API.
* `cp_gaia_virtual_switch_facts` – get virtual-switch objects facts on Check VSNext machine Point over Web Services API.
